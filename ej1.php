...
echo "<p> Esta es la frase 1 a mostrar en la página web. </p>"
?>
<p> Esta es la frase 2 a mostrar en la página web. </p>
<?php
print("<p>Esta es la frase 3 a mostrar en la página web.</p>");
